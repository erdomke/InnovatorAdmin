...
namespace Pipes.Css
{
  ...
  public sealed partial class Parser
  {
    ...
    internal static ISelector ParseSelector(string selector)
    {
    ...
    private bool AddTerm(Term value)
    {
      ...
      else if (_parsingContext == ParsingContext.InSingleValue || _parsingContext == ParsingContext.InMediaValue)
      {
        _terms.AddTerm(value);
      }
      else
