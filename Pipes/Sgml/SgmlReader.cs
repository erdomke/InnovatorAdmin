...
namespace Pipes.Sgml
{
  ...
  public class SgmlReader : XmlReader
  {
    ...
    public string SimulatedNode { get; set; }

    private void LazyLoadDtd(Uri baseUri)
    {
      if (this.m_dtd == null && !this.m_ignoreDtd)
      {
        switch (this.m_syslit ?? "")
        {
          case "":
          case "http://www.w3.org/TR/html4/strict.dtd":
          case "http://www.w3.org/TR/html4/loose.dtd":
          case "http://www.w3.org/TR/html4/frameset.dtd":
          ...
          case "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd":
            if (!string.IsNullOrEmpty(this.m_syslit) || (this.m_docType != null && StringUtilities.EqualsIgnoreCase(this.m_docType, "html")))
            {
    ...
    public override string Name
    {
      get
      {
        ...
        {
          return this.NameTable.Add(result);
        }
      }
    }
    ...
    public override string Prefix
    {
      get
      {
        ...
        if (result != null)
        {
          ...
          if (colon != -1)
          {
            result = this.NameTable.Add(result.Substring(0, colon));
          }
          else
          {
            result = string.Empty;
    ...
    public override bool IsEmptyElement
    {
      get
      {
        var result = ((this.m_state == State.Markup || this.m_state == State.Attr || this.m_state == State.AttrValue) ? this.m_node.IsEmpty : false);

        // Force the result to true for html void elements (http://www.w3.org/TR/html5/syntax.html)
        //if (!result && this.m_docType == "HTML" && this.NodeType == XmlNodeType.Element) 
        //{ 
    ...
    private bool ParseComment()
    {
      ...
      ValidateContent(Push(null, XmlNodeType.Comment, value));
      return true;
    }
    ...
    private void ExpandEntity(StringBuilder sb, char terminator)
    {
      ...
      else
      {
        ...
        {
          if (this.m_dtd == null && this.m_docType == "HTML")
          {
            char entChar = '\0';
            switch (name)
            {
              case "nbsp": entChar = (char)160; break;
              case "iexcl": entChar = (char)161; break;
              case "cent": entChar = (char)162; break;
              case "pound": entChar = (char)163; break;
              case "curren": entChar = (char)164; break;
              case "yen": entChar = (char)165; break;
              case "brvbar": entChar = (char)166; break;
              case "sect": entChar = (char)167; break;
              case "uml": entChar = (char)168; break;
              case "copy": entChar = (char)169; break;
              case "ordf": entChar = (char)170; break;
              case "laquo": entChar = (char)171; break;
              case "not": entChar = (char)172; break;
              case "shy": entChar = (char)173; break;
              case "reg": entChar = (char)174; break;
              case "macr": entChar = (char)175; break;
              case "deg": entChar = (char)176; break;
              case "plusmn": entChar = (char)177; break;
              case "sup2": entChar = (char)178; break;
              case "sup3": entChar = (char)179; break;
              case "acute": entChar = (char)180; break;
              case "micro": entChar = (char)181; break;
              case "para": entChar = (char)182; break;
              case "middot": entChar = (char)183; break;
              case "cedil": entChar = (char)184; break;
              case "sup1": entChar = (char)185; break;
              case "ordm": entChar = (char)186; break;
              case "raquo": entChar = (char)187; break;
              case "frac14": entChar = (char)188; break;
              case "frac12": entChar = (char)189; break;
              case "frac34": entChar = (char)190; break;
              case "iquest": entChar = (char)191; break;
              case "Agrave": entChar = (char)192; break;
              case "Aacute": entChar = (char)193; break;
              case "Acirc": entChar = (char)194; break;
              case "Atilde": entChar = (char)195; break;
              case "Auml": entChar = (char)196; break;
              case "Aring": entChar = (char)197; break;
              case "AElig": entChar = (char)198; break;
              case "Ccedil": entChar = (char)199; break;
              case "Egrave": entChar = (char)200; break;
              case "Eacute": entChar = (char)201; break;
              case "Ecirc": entChar = (char)202; break;
              case "Euml": entChar = (char)203; break;
              case "Igrave": entChar = (char)204; break;
              case "Iacute": entChar = (char)205; break;
              case "Icirc": entChar = (char)206; break;
              case "Iuml": entChar = (char)207; break;
              case "ETH": entChar = (char)208; break;
              case "Ntilde": entChar = (char)209; break;
              case "Ograve": entChar = (char)210; break;
              case "Oacute": entChar = (char)211; break;
              case "Ocirc": entChar = (char)212; break;
              case "Otilde": entChar = (char)213; break;
              case "Ouml": entChar = (char)214; break;
              case "times": entChar = (char)215; break;
              case "Oslash": entChar = (char)216; break;
              case "Ugrave": entChar = (char)217; break;
              case "Uacute": entChar = (char)218; break;
              case "Ucirc": entChar = (char)219; break;
              case "Uuml": entChar = (char)220; break;
              case "Yacute": entChar = (char)221; break;
              case "THORN": entChar = (char)222; break;
              case "szlig": entChar = (char)223; break;
              case "agrave": entChar = (char)224; break;
              case "aacute": entChar = (char)225; break;
              case "acirc": entChar = (char)226; break;
              case "atilde": entChar = (char)227; break;
              case "auml": entChar = (char)228; break;
              case "aring": entChar = (char)229; break;
              case "aelig": entChar = (char)230; break;
              case "ccedil": entChar = (char)231; break;
              case "egrave": entChar = (char)232; break;
              case "eacute": entChar = (char)233; break;
              case "ecirc": entChar = (char)234; break;
              case "euml": entChar = (char)235; break;
              case "igrave": entChar = (char)236; break;
              case "iacute": entChar = (char)237; break;
              case "icirc": entChar = (char)238; break;
              case "iuml": entChar = (char)239; break;
              case "eth": entChar = (char)240; break;
              case "ntilde": entChar = (char)241; break;
              case "ograve": entChar = (char)242; break;
              case "oacute": entChar = (char)243; break;
              case "ocirc": entChar = (char)244; break;
              case "otilde": entChar = (char)245; break;
              case "ouml": entChar = (char)246; break;
              case "divide": entChar = (char)247; break;
              case "oslash": entChar = (char)248; break;
              case "ugrave": entChar = (char)249; break;
              case "uacute": entChar = (char)250; break;
              case "ucirc": entChar = (char)251; break;
              case "uuml": entChar = (char)252; break;
              case "yacute": entChar = (char)253; break;
              case "thorn": entChar = (char)254; break;
              case "yuml": entChar = (char)255; break;
              case "fnof": entChar = (char)402; break;
              case "Alpha": entChar = (char)913; break;
              case "Beta": entChar = (char)914; break;
              case "Gamma": entChar = (char)915; break;
              case "Delta": entChar = (char)916; break;
              case "Epsilon": entChar = (char)917; break;
              case "Zeta": entChar = (char)918; break;
              case "Eta": entChar = (char)919; break;
              case "Theta": entChar = (char)920; break;
              case "Iota": entChar = (char)921; break;
              case "Kappa": entChar = (char)922; break;
              case "Lambda": entChar = (char)923; break;
              case "Mu": entChar = (char)924; break;
              case "Nu": entChar = (char)925; break;
              case "Xi": entChar = (char)926; break;
              case "Omicron": entChar = (char)927; break;
              case "Pi": entChar = (char)928; break;
              case "Rho": entChar = (char)929; break;
              case "Sigma": entChar = (char)931; break;
              case "Tau": entChar = (char)932; break;
              case "Upsilon": entChar = (char)933; break;
              case "Phi": entChar = (char)934; break;
              case "Chi": entChar = (char)935; break;
              case "Psi": entChar = (char)936; break;
              case "Omega": entChar = (char)937; break;
              case "alpha": entChar = (char)945; break;
              case "beta": entChar = (char)946; break;
              case "gamma": entChar = (char)947; break;
              case "delta": entChar = (char)948; break;
              case "epsilon": entChar = (char)949; break;
              case "zeta": entChar = (char)950; break;
              case "eta": entChar = (char)951; break;
              case "theta": entChar = (char)952; break;
              case "iota": entChar = (char)953; break;
              case "kappa": entChar = (char)954; break;
              case "lambda": entChar = (char)955; break;
              case "mu": entChar = (char)956; break;
              case "nu": entChar = (char)957; break;
              case "xi": entChar = (char)958; break;
              case "omicron": entChar = (char)959; break;
              case "pi": entChar = (char)960; break;
              case "rho": entChar = (char)961; break;
              case "sigmaf": entChar = (char)962; break;
              case "sigma": entChar = (char)963; break;
              case "tau": entChar = (char)964; break;
              case "upsilon": entChar = (char)965; break;
              case "phi": entChar = (char)966; break;
              case "chi": entChar = (char)967; break;
              case "psi": entChar = (char)968; break;
              case "omega": entChar = (char)969; break;
              case "thetasym": entChar = (char)977; break;
              case "upsih": entChar = (char)978; break;
              case "piv": entChar = (char)982; break;
              case "bull": entChar = (char)8226; break;
              case "hellip": entChar = (char)8230; break;
              case "prime": entChar = (char)8242; break;
              case "Prime": entChar = (char)8243; break;
              case "oline": entChar = (char)8254; break;
              case "frasl": entChar = (char)8260; break;
              case "weierp": entChar = (char)8472; break;
              case "image": entChar = (char)8465; break;
              case "real": entChar = (char)8476; break;
              case "trade": entChar = (char)8482; break;
              case "alefsym": entChar = (char)8501; break;
              case "larr": entChar = (char)8592; break;
              case "uarr": entChar = (char)8593; break;
              case "rarr": entChar = (char)8594; break;
              case "darr": entChar = (char)8595; break;
              case "harr": entChar = (char)8596; break;
              case "crarr": entChar = (char)8629; break;
              case "lArr": entChar = (char)8656; break;
              case "uArr": entChar = (char)8657; break;
              case "rArr": entChar = (char)8658; break;
              case "dArr": entChar = (char)8659; break;
              case "hArr": entChar = (char)8660; break;
              case "forall": entChar = (char)8704; break;
              case "part": entChar = (char)8706; break;
              case "exist": entChar = (char)8707; break;
              case "empty": entChar = (char)8709; break;
              case "nabla": entChar = (char)8711; break;
              case "isin": entChar = (char)8712; break;
              case "notin": entChar = (char)8713; break;
              case "ni": entChar = (char)8715; break;
              case "prod": entChar = (char)8719; break;
              case "sum": entChar = (char)8721; break;
              case "minus": entChar = (char)8722; break;
              case "lowast": entChar = (char)8727; break;
              case "radic": entChar = (char)8730; break;
              case "prop": entChar = (char)8733; break;
              case "infin": entChar = (char)8734; break;
              case "ang": entChar = (char)8736; break;
              case "and": entChar = (char)8869; break;
              case "or": entChar = (char)8870; break;
              case "cap": entChar = (char)8745; break;
              case "cup": entChar = (char)8746; break;
              case "int": entChar = (char)8747; break;
              case "there4": entChar = (char)8756; break;
              case "sim": entChar = (char)8764; break;
              case "cong": entChar = (char)8773; break;
              case "asymp": entChar = (char)8776; break;
              case "ne": entChar = (char)8800; break;
              case "equiv": entChar = (char)8801; break;
              case "le": entChar = (char)8804; break;
              case "ge": entChar = (char)8805; break;
              case "sub": entChar = (char)8834; break;
              case "sup": entChar = (char)8835; break;
              case "nsub": entChar = (char)8836; break;
              case "sube": entChar = (char)8838; break;
              case "supe": entChar = (char)8839; break;
              case "oplus": entChar = (char)8853; break;
              case "otimes": entChar = (char)8855; break;
              case "perp": entChar = (char)8869; break;
              case "sdot": entChar = (char)8901; break;
              case "lceil": entChar = (char)8968; break;
              case "rceil": entChar = (char)8969; break;
              case "lfloor": entChar = (char)8970; break;
              case "rfloor": entChar = (char)8971; break;
              case "lang": entChar = (char)9001; break;
              case "rang": entChar = (char)9002; break;
              case "loz": entChar = (char)9674; break;
              case "spades": entChar = (char)9824; break;
              case "clubs": entChar = (char)9827; break;
              case "hearts": entChar = (char)9829; break;
              case "diams": entChar = (char)9830; break;
              case "quot": entChar = (char)34; break;
              case "amp": entChar = (char)38; break;
              case "lt": entChar = (char)60; break;
              case "gt": entChar = (char)62; break;
              case "OElig": entChar = (char)338; break;
              case "oelig": entChar = (char)339; break;
              case "Scaron": entChar = (char)352; break;
              case "scaron": entChar = (char)353; break;
              case "Yuml": entChar = (char)376; break;
              case "circ": entChar = (char)710; break;
              case "tilde": entChar = (char)732; break;
              case "ensp": entChar = (char)8194; break;
              case "emsp": entChar = (char)8195; break;
              case "thinsp": entChar = (char)8201; break;
              case "zwnj": entChar = (char)8204; break;
              case "zwj": entChar = (char)8205; break;
              case "lrm": entChar = (char)8206; break;
              case "rlm": entChar = (char)8207; break;
              case "ndash": entChar = (char)8211; break;
              case "mdash": entChar = (char)8212; break;
              case "lsquo": entChar = (char)8216; break;
              case "rsquo": entChar = (char)8217; break;
              case "sbquo": entChar = (char)8218; break;
              case "ldquo": entChar = (char)8220; break;
              case "rdquo": entChar = (char)8221; break;
              case "bdquo": entChar = (char)8222; break;
              case "dagger": entChar = (char)8224; break;
              case "Dagger": entChar = (char)8225; break;
              case "permil": entChar = (char)8240; break;
              case "lsaquo": entChar = (char)8249; break;
              case "rsaquo": entChar = (char)8250; break;
            }
            if (entChar != '\0')
            {
              sb.Append(entChar);
