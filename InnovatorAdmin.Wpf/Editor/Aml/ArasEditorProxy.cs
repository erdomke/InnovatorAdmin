...
namespace InnovatorAdmin.Editor
{
  public class ArasEditorProxy : IEditorProxy
  {
    ...
    private InnovatorAdmin.Editor.AmlEditorHelper _helper;
    ...
    {
      _helper = new InnovatorAdmin.Editor.AmlEditorHelper();
    ...
    public InnovatorAdmin.Editor.IEditorHelper GetHelper()
    {
      return _helper;
    }
    ...
    private class ResultObject : IResultObject
    {
      ...
      public ResultObject(TestSuite suite, IAsyncConnection conn)
      {
        ...
        using (var writer = new InnovatorAdmin.Editor.RopeWriter(rope))
        {
          suite.Write(writer);
        }
