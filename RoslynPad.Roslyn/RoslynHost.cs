...
namespace RoslynPad.Roslyn
{
    public sealed class RoslynHost
    {
        ...
        //    typeof(Aras.IOM.Item)
        //};

        private IEnumerable<AssemblyRef> _refAssemblies;
        ...
        public RoslynHost(IEnumerable<AssemblyRef> refAssemblies)
        {
            ...
            _references = refAssemblies.Select(t =>
            ...
            _compilationOptions = new CSharpCompilationOptions(OutputKind.NetModule,
                usings: refAssemblies.SelectMany(x => x.Namespaces).ToImmutableArray());
        ...
        public async Task<object> Execute()
        {
            ...
            var state = await CSharpScript.RunAsync(text.ToString(),
                ScriptOptions.Default
                    .AddImports(_refAssemblies.SelectMany(x => x.Namespaces))
                    .AddReferences(_refAssemblies.Select(x => MetadataReference.CreateFromFile(Path.GetFullPath(x.Location))))).ConfigureAwait(false);
