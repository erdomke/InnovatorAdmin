...
namespace Innovator.Client.Tests
{
  ...
  public class SqlBatchWriterTests
  {
    ...
    public void SqlBatchWriter_ParamSubs()
    {
      ...
      sql.Command("insert into innovator._sync_mes_entity_tester (id, item_number, classification, line) values (@0, @1, 'Asset', @2);", "3Zero", "3One", "3Two");
...
insert into innovator._sync_mes_entity_tester (id, item_number, classification, line) values (N&apos;3Zero&apos;, N&apos;3One&apos;, &apos;Asset&apos;, N&apos;3Two&apos;);
</sql>", sql.ToString());
    }
  }
}
