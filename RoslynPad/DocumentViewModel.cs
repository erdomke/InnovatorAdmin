...
namespace RoslynPad
{
    internal class DocumentViewModel : NotificationObject
    {
        ...
        private DocumentViewModel(IParentViewModel mainViewModel)
        {
        ...
        public IParentViewModel MainViewModel { get; }
        ...
        public static DocumentViewModel CreateRoot(IParentViewModel mainViewModel)
        {
            return new DocumentViewModel(mainViewModel);
        }

        public static DocumentViewModel CreateAutoSave(IParentViewModel mainViewModel, string path)
        {
        ...
        {
            return System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Innovator Admin\\AutoSave");
        }

        private DocumentViewModel(IParentViewModel mainViewModel, string path, bool isFolder)
        {
            MainViewModel = mainViewModel;
            Path = path;
            IsFolder = isFolder;
