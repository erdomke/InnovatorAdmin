...
namespace RoslynPad
{
  internal sealed class MainViewModel : NotificationObject, IParentViewModel
  {
    ...
    public MainViewModel()
    {
      ...
      OpenDocuments = new ObservableCollection<MethodViewModel>(LoadAutoSaves(DocumentRoot.Path));
    ...
    public IEnumerable<MethodViewModel> LoadAutoSaves(string root)
    {
      return Directory.EnumerateFiles(root, DocumentViewModel.GetAutoSaveName("*"), SearchOption.AllDirectories)
          .Select(x => new MethodViewModel(this, DocumentViewModel.CreateAutoSave(this, x)));
    }
    ...
    public ObservableCollection<MethodViewModel> OpenDocuments { get; }
    ...
    public void OpenDocument(DocumentViewModel document)
    {
      ...
      {
        openDocument = new MethodViewModel(this, document);
    ...
    {
      var openDocument = new MethodViewModel(this, null);
      OpenDocuments.Add(openDocument);
      CurrentOpenDocument = openDocument;
    }
