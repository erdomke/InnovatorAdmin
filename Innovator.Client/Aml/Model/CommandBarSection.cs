...
namespace Innovator.Client.Model
{
  ...
  public class CommandBarSection : Item
  {
    ...
    static CommandBarSection() { Innovator.Client.Item.AddNullItem<CommandBarSection>(new CommandBarSection { _attr = ElementAttribute.ReadOnly | ElementAttribute.Null }); }
