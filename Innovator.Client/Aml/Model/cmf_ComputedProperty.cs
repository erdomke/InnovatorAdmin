...
namespace Innovator.Client.Model
{
  ...
  public class cmf_ComputedProperty : Item, INullRelationship<cmf_PropertyType>
  {
    ...
    static cmf_ComputedProperty() { Innovator.Client.Item.AddNullItem<cmf_ComputedProperty>(new cmf_ComputedProperty { _attr = ElementAttribute.ReadOnly | ElementAttribute.Null }); }
