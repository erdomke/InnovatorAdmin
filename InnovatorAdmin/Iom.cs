...
namespace Aras.Tools.InnovatorAdmin
{
  public static class Iom
  {
    ...
    private static Dictionary<string, Sponsor<IConnectionFactory>> _versions = new Dictionary<string, Sponsor<IConnectionFactory>>();
    ...
    {
      Sponsor<IConnectionFactory> factory;
      ...
      if (!_versions.TryGetValue(version, out factory))
      {
        ...
        factory = new Sponsor<IConnectionFactory>((IConnectionFactory)domain.CreateInstanceAndUnwrap("IomWrapper, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "IomWrapper.IomConnectionFactory"));
